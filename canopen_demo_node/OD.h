...
typedef struct {
    ...
    struct {
        uint8_t highestSub_indexSupported;
        float32_t cabinTemperature;
        float32_t outsideTemperature;
    } x2000_temperatureReadings;
    struct {
        uint8_t highestSub_indexSupported;
        uint8_t frontLeftTyre;
        uint8_t frontRightTyre;
        uint8_t reartLeftTyre;
        uint8_t rearRighttTyre;
...
#define OD_ENTRY_H2000_temperatureReadings &OD->list[33]
#define OD_ENTRY_H2001_pressureReadings &OD->list[34]
#define OD_ENTRY_H2002_accelerometerReadings &OD->list[35]
#define OD_ENTRY_H2003_vehicleSpeed &OD->list[36]
