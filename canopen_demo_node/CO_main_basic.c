...
#endif
            OD_RAM.x2000_temperatureReadings.cabinTemperature = 20.0f + ((float)rand() / (float)RAND_MAX) * 5.0f;
            OD_RAM.x2000_temperatureReadings.outsideTemperature = 20.0f + ((float)rand() / (float)RAND_MAX) * 5.0f;

            OD_RAM.x2001_pressureReadings.frontLeftTyre = 29 + rand() % 3;
            OD_RAM.x2001_pressureReadings.frontRightTyre = 29 + rand() % 3;
            OD_RAM.x2001_pressureReadings.reartLeftTyre = 29 + rand() % 3;
            OD_RAM.x2001_pressureReadings.rearRighttTyre = 29 + rand() % 3;

            /* Generate random accelerometer readings in mg (e.g., -500 to +500 mg) */
            OD_RAM.x2002_accelerometerReadings.X_Axis_mg = -500.0f + ((float)rand() / (float)RAND_MAX) * 1000.0f;
            OD_RAM.x2002_accelerometerReadings.Y_Axis_mg = -500.0f + ((float)rand() / (float)RAND_MAX) * 1000.0f;
            OD_RAM.x2002_accelerometerReadings.Z_Axis_mg = -500.0f + ((float)rand() / (float)RAND_MAX) * 1000.0f;
            
            OD_RAM.x2003_vehicleSpeed = 50.0f + ((float)rand() / (float)RAND_MAX) * 50.0f; /* Speed in km/h */
