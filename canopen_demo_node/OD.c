...
OD_ATTR_RAM OD_RAM_t OD_RAM = {
    ...
    .x2000_temperatureReadings = {
        .highestSub_indexSupported = 0x02,
        .cabinTemperature = 0,
        .outsideTemperature = 0
    },
    .x2001_pressureReadings = {
        .highestSub_indexSupported = 0x04,
        .frontLeftTyre = 0x00,
        .frontRightTyre = 0x00,
        .reartLeftTyre = 0x00,
    ...
    .x2002_accelerometerReadings = {
        .highestSub_indexSupported = 0x03,
        .X_Axis_mg = 0x0000,
        .Y_Axis_mg = 0x0000,
        .Z_Axis_mg = 0x0000
    },
    .x2003_vehicleSpeed = 0x0000
};
...
typedef struct {
    ...
    OD_obj_record_t o_2000_temperatureReadings[3];
    OD_obj_record_t o_2001_pressureReadings[5];
    OD_obj_record_t o_2002_accelerometerReadings[4];
    OD_obj_var_t o_2003_vehicleSpeed;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_2000_temperatureReadings = {
        {
            .dataOrig = &OD_RAM.x2000_temperatureReadings.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2000_temperatureReadings.cabinTemperature,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 4
        },
        {
            .dataOrig = &OD_RAM.x2000_temperatureReadings.outsideTemperature,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 4
        }
    },
    .o_2001_pressureReadings = {
        {
            .dataOrig = &OD_RAM.x2001_pressureReadings.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2001_pressureReadings.frontLeftTyre,
            .subIndex = 1,
            .attribute = ODA_SDO_RW,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2001_pressureReadings.frontRightTyre,
            .subIndex = 2,
            .attribute = ODA_SDO_RW,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2001_pressureReadings.reartLeftTyre,
            .subIndex = 3,
            .attribute = ODA_SDO_RW,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2001_pressureReadings.rearRighttTyre,
            .subIndex = 4,
            .attribute = ODA_SDO_RW,
            .dataLength = 1
        }
    },
    .o_2002_accelerometerReadings = {
        {
            .dataOrig = &OD_RAM.x2002_accelerometerReadings.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x2002_accelerometerReadings.X_Axis_mg,
            .subIndex = 1,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2002_accelerometerReadings.Y_Axis_mg,
            .subIndex = 2,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 2
        },
        {
            .dataOrig = &OD_RAM.x2002_accelerometerReadings.Z_Axis_mg,
            .subIndex = 3,
            .attribute = ODA_SDO_RW | ODA_MB,
            .dataLength = 2
        }
    ...
    .o_2003_vehicleSpeed = {
        .dataOrig = &OD_RAM.x2003_vehicleSpeed,
        .attribute = ODA_SDO_RW | ODA_MB,
        .dataLength = 2
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x2000, 0x03, ODT_REC, &ODObjs.o_2000_temperatureReadings, NULL},
    {0x2001, 0x05, ODT_REC, &ODObjs.o_2001_pressureReadings, NULL},
    {0x2002, 0x04, ODT_REC, &ODObjs.o_2002_accelerometerReadings, NULL},
    {0x2003, 0x01, ODT_VAR, &ODObjs.o_2003_vehicleSpeed, NULL},
